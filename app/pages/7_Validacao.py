...
with resultados:
    for rel, tit in [
        ...
        ("referencias/benchmarks_csv/bench_fase_variavel.csv", "Fase variável [19]"),
        ("referencias/benchmarks_csv/bench_gauss_jeszenszki.csv", "Gaussiano [34]"),
        ("referencias/benchmarks_csv/bench_aziz.csv", "Aziz He₂ [25]"),
        ("referencias/benchmarks_csv/bench_he_dimer.csv", "He₂ com LJ [22]"),
    ]:
