...
same `(a, r0)`, do they predict the same binding energy?

**The answer, measured here.** Yes, to within 1%, for two real systems nine
orders of magnitude apart in energy — the deuteron and the helium-4 dimer.
...
notas_teoria/
    Teoria_e_Implementacao.pdf every function and every constant explained
```
...
jupyter lab notebooks/2_dois_corpos/two_body_scattering.ipynb   # ~55 s, Run All
...
| tuning, 12 cases | Tables 3 and 4 | 10 within 0.2% |
