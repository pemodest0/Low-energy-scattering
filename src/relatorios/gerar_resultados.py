...
from ..dois_corpos import espalhamento, analitico, ajuste
from ..dois_corpos.potenciais import FABRICAS
from ..literatura.tabelas_artigo import (TABELA1, TABELA2, TABELA3, TABELA4,
                             NOMES_PARAM)
